...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">Job List</h1>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <tr>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                        href="{{url('job-details')}}"> HTML Developer - Fresher</a></p>
                                    ...
                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>Nov
                                            12 2022</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                        href="{{url('job-details')}}"> React Lead Developer</a></p>
                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);" class="fw-semibold mb-0">Voluptatem
                                                Pvt.Ltd</a>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                        href="{{url('job-details')}}"> Vuejs Frontend Developer</a></p>
                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>Jan
                                            15 2022</span></td>
                                    <td>
                                        <a href="{{url('job-details')}}"
                                            class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="ms-2">
                                                <p class="fw-semibold mb-0 d-flex align-items-center"><a
                                                        href="{{url('job-details')}}"> Wordpress Developer - Remote</a>
                                                </p>
                                                <p class="fs-12 text-muted mb-0">Remote/Onsite</p>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);" class="fw-semibold mb-0">Obligation
                                                Pvt.Ltd</a>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td><span class="badge bg-primary-transparent"><i class="bi bi-clock me-1"></i>Feb
                                            12 2022</span></td>
                                    <td>
                                        <a href="{{url('job-details')}}"
                                            class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
