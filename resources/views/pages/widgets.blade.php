                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="avatar-list-stacked">
                                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle overflow-hidden" data-bs-toggle="tooltip" aria-label="Mis x matched"><img src="{{asset('build/assets/images/faces/2.jpg')}}" alt="img" class="w-100"></a>
                                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle overflow-hidden" data-bs-toggle="tooltip" aria-label="Barbel Bob"><img src="{{asset('build/assets/images/faces/12.jpg')}}" alt="img" class="w-100"></a>
                                                    <a href="javascript:void(0);" class="avatar avatar-sm rounded-circle overflow-hidden" data-bs-toggle="tooltip" aria-label="Phan Rel"><img src="{{asset('build/assets/images/faces/20.jpg')}}" alt="img" class="w-100"></a>
