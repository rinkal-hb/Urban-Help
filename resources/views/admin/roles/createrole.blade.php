                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="perm1">User Management</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="perm2">
                                        <label class="form-check-label" for="perm2">Role Management</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="perm3">
                                        <label class="form-check-label" for="perm3">Permission Management</label>
                                    </div>
                                </div>
                            </div>
                        </div>
