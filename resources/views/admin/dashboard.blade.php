...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"> Welcome Back!    
            </h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-9 col-xl-10 col-lg-9 col-md-9 col-sm-8 col-8 px-0">
                                        ...
                                        <div class="text-muted mb-1 fs-12">
                                            <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom" id="total-customers">
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xxl-9 col-xl-10 col-lg-9 col-md-9 col-sm-8 col-8 px-0">
                                        <div class="mb-2">Total Providers</div>
                                        <div class="text-muted mb-1 fs-12">
                                            <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom" id="total-providers">
                                                <div class="spinner-border spinner-border-sm" role="status"></div>
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xxl-9 col-xl-10 col-lg-9 col-md-9 col-sm-8 col-8 px-0">
                                        <div class="mb-2">Total Bookings</div>
                                        <div class="text-muted mb-1 fs-12">
                                            <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom" id="total-bookings">
                                                <div class="spinner-border spinner-border-sm" role="status"></div>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xxl-9 col-xl-10 col-lg-9 col-md-9 col-sm-8 col-8 px-0">
                                        ...
                                        <div class="text-muted mb-1 fs-12">
                                            <span class="text-dark fw-semibold fs-20 lh-1 vertical-bottom" id="total-revenue">
                                                <div class="spinner-border spinner-border-sm" role="status"></div>
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="card custom-card overflow-hidden">
                            <div class="ecommerce-sale-image">
                                <img src="{{ asset('build/assets/images/ecommerce/png/35.png') }}" class="card-img-top"
                                    alt="...">
                                <div class="card-img-overlay d-flex flex-column p-4 text-fixed-white">
                                    ...
                                    <p class="ecommerce-bankoffer-details">Bank Offer 10% off on Aches Bank Credit Cards,
                                        up
                                        to $10. On orders of $500 and above <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                <a href="javascript:void(0);" class="text-primary fs-15 fw-semibold">Biggest sale is
                                    back.</a>
                                <p class="mb-4 mt-1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore harum
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/1.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/2.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/3.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/4.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/5.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/6.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/7.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/8.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/9.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/10.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                            ...
                                            <table class="table card-table table-vcenter text-nowrap mb-0">
                                                <tbody class="active-tab">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/12.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/13.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="avatar avatar-md">
                                                                <img src="{{ asset('build/assets/images/ecommerce/png/14.png') }}"
                                                                    alt="">
                                                            </span>
                                                        </td>
                                                        <td>
                                        ...
                                        <tbody class="top-selling">
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img src="{{ asset('build/assets/images/ecommerce/png/36.png') }}"
                                            ...
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img src="{{ asset('build/assets/images/ecommerce/png/38.png') }}"
                                                            class="p-2 rounded-pill bg-light" alt="">
                                                    </span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="text-center lh-1">
                                                    <span class="avatar avatar-md">
                                                        <img src="{{ asset('build/assets/images/ecommerce/png/39.png') }}"
                                                            class="p-2 rounded-pill bg-light" alt="">
                                                    </span>
                                                </td>
                                ...
                                <ul class="mb-0 pt-3 list-unstyled">
                                    ...
                                    <li class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img src="{{ asset('build/assets/images/flags/spain_flag.jpg') }}"
                                                        alt="">
                                                </span>
                                    ...
                                    <li class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img src="{{ asset('build/assets/images/flags/argentina_flag.jpg') }}"
                                                        alt="">
                                                </span>
                                    ...
                                    <li class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center lh-1">
                                                <span class="avatar avatar-xs me-2 avatar-rounded">
                                                    <img src="{{ asset('build/assets/images/flags/uae_flag.jpg') }}"
                                                        alt="">
                                                </span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="me-2 lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <img src="{{ asset('build/assets/images/ecommerce/png/37.png') }}"
                                                            alt="">
                                                    </span>
                                                </div>
